...
| 图片 | 支持 | 取决于所选视觉 skill | `xhs-visual-director`、HTML 模板；可选外部安装 `cover-anchor-system`、`guizang-social-card-skill` | 按 fallback 链降级 |
...
项目外的干净环境验收步骤见 [`05-验收/全新环境验收.md`](05-验收/全新环境验收.md)。
